...
#define RCC_APB2RSTR_SPI1_RST (0x00001000) 
#define RCC_APB2RSTR_SYSCFGCOMPEN_RST (0x00000001) 
...
#define RCC_APB2ENR_SPI1_EN   (0x00001000)  // SPI 1 clock enable
#define RCC_APB2ENR_SYSCFGCOMP_EN (0x00000001) // SysConfig (including EXTI) enable
...
// SPI on APB2
#define RCC_APB2ENR_SPI1  (0x00001000)
